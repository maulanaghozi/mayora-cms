...
import {text, toggler_container, border, open, icon, text_container} from './SidebarToggler.module.scss';
        ...
        <React.Fragment>
            ...
            <div className={classNames(toggler_container, openClass)}>
                <div className={text_container}>
                    ...
                    <LeftDoubleChevronIcon className={icon} onClick={toggle} transform={props.isOpen ? '' : 'scale(-1, 1)'}/>
                </div>
            </div>
        </React.Fragment>
    )
