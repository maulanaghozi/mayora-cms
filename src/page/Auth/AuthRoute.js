...
import { BrowserRouter as Router, Route, Link, Switch, useLocation, useRouteMatch, Redirect } from 'react-router-dom';
...
export default function AuthPage() {
    ...
    return (
        // <div style={{width: '100%', overflowX: "hidden", paddingTop: 60}}>
            <AuthBackground>
                <Switch>
